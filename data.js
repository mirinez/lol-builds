            ...
            "first_item": [
                {
                    ...
                    "stats": [
                        "+60 Ability Power",
                        "+300 Health",
                        "Passive: Dealing ability damage burns enemies for 1% of their max HP magic damage every 0.5s over 3s (6% total). Capped at 20 per tick against monsters.",
                        "Passive: For each second in combat with enemy champions, deal 2% increased damage, stacking up to 3 times (6% max)."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+50% Attack Speed",
                        "+15 Ability Haste",
                        "Passive: Basic attacks deal 15 (+ 25% AP) bonus magic damage on-hit."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+600 Mana",
                        "+15 Ability Haste",
                        "Passive: Dealing damage with your ultimate ability creates a scorched zone beneath the target for 3s, dealing 15 (+ 1.25% AP) magic damage every 0.25s (180 + 15% AP total) and reducing their Magic Resistance by 10 (3s cooldown per target)."
                    ],
            ...
            "second_item": [
                {
                    ...
                    "stats": [
                        ...
                        "Passive: Damage against champions benefits from +15 flat magic penetration, increasing as the target's current health is lower (maximum value at ≤40% HP). Also increases instances of damage that already critically strike by 20%."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+600 Mana",
                        "+20 Ability Haste",
                        "Passive: Dealing ability damage burns enemies for 10 (+ 1% AP) magic damage every 0.5s over 3s (60 + 6% AP total).",
                        "Passive: For each champion, epic monster, or large monster afflicted with Baleful Blaze's burn, gain +4% AP (stacks per target)."
                    ],
            ...
            "third_item": [
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+400 Health",
                        "+15 Ability Haste",
                        "Passive: Dealing magic damage with abilities or passives to a champion applies a stack for 6s, up to 4 stacks (once per cast every 0.3s). Each stack reduces their Magic Resistance by 7.5% (up to 30% at 4 stacks)."
                    ],
            ...
            "fourth_item": [
                {
                    ...
                    "stats": [
                        "+130 Ability Power",
                        "Passive: Increase your total Ability Power by 30% (multiplicative, applies recursively with other AP sources)."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+350 Health",
                        "+15 Ability Haste",
                        "Passive: For each second in combat with champions, deal 2% increased damage, stacking up to 4 times (8% max). While fully stacked, gain Omnivamp (10% melee / 6% ranged).",
                        "Passive: Gain AP equal to 2% of your bonus Health."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        ...
                        "+350 Health",
                        "+15 Ability Haste",
                        "Passive: Dealing magic damage to enemy champions inflicts 40% Grievous Wounds for 3s (reduces all healing received by 40%)."
                    ],
            ...
            "situational": [
                {
                    ...
                    "stats": [
                        ...
                        "+4% Move Speed",
                        "+10 Ability Haste",
                        "Passive: After using an ability, your next basic attack within 10s gains +50% bonus attack speed and deals 75% base AD (+ 40% AP) bonus magic damage on-hit (1.5s cooldown, starts after the empowered attack lands)."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        "+105 Ability Power",
                        "+50 Armor",
                        "Active: Put yourself in stasis for 2.5s, becoming untargetable and invulnerable but unable to move, attack, or cast (120s cooldown)."
                    ],
                ...
                },
                {
                    ...
                    "stats": [
                        "+105 Ability Power",
                        "+40 Magic Resistance",
                        "Passive: Grants a spell shield that blocks the next enemy ability. Refreshes after taking no damage from enemy champions for 40s."
                    ],
